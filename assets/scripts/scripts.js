...
typewriter.typeString('hey there!')
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("my name is mary.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm a student at university of houston (go cougs!).")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm also interested in web development.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("fan of bacon on pizza.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i also like to exercise.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
